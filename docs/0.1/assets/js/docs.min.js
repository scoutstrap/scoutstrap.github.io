...
*/(function(){'use strict'
document.querySelectorAll('.tooltip-demo').forEach(function(tooltip){new bootstrap.Tooltip(tooltip,{selector:'[data-toggle="tooltip"]'})})
document.querySelectorAll('[data-toggle="popover"]').forEach(function(popover){new bootstrap.Popover(popover)})
...
document.querySelectorAll('figure.highlight, div.highlight').forEach(function(element){element.insertAdjacentHTML('beforebegin',btnHtml)})
...
bsCustomFileInput.init()})();(function(){'use strict'
...
return origin}
window.docsearch({apiKey:'2e6ae9e6115140f2e7486c0b9a348508',indexName:'scoutstrap',inputSelector:'#search-input',algoliaOptions:{facetFilters:['version:'+siteDocsVersion]},transformData:function(hits){return hits.map(function(hit){var currentUrl=getOrigin()
